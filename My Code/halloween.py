...
from picofx.colour import RED, YELLOW, GREEN, CYAN, BLUE, MAGENTA, BLACK
...
"""
Play the halloween theme with accompanying lights on TinyFX.
...
try:
    while not tiny.boot_pressed():
        ...
        tiny.rgb.set_rgb(*RGBS[index % len(RGBS)])
